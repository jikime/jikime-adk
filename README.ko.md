...
> 자세한 내용: [J.A.R.V.I.S. 문서](./docs/ko/jarvis.md) | [F.R.I.D.A.Y. 문서](./docs/ko/friday.md)
...
| **세션 메모리** | 세션 간 컨텍스트 연속성, 하이브리드 벡터+텍스트 검색 | [메모리 시스템](./docs/ko/memory.md) |
...
> 상세 문서: [메모리 시스템](./docs/ko/memory.md) | [세션 메모리 흐름](./docs/ko/session-memory-flow.md)
...
> 전체 명령어 목록: [명령어 레퍼런스](./docs/ko/commands.md)
...
> 전체 에이전트 목록: [에이전트 카탈로그](./docs/ko/agents.md)
...
> 상세 내용: [DDD 방법론 문서](./docs/ko/tdd-ddd.md)
...
| [세션 메모리 시스템](./docs/ko/memory.md) | 2-Layer Memory, MCP 도구, 임베딩, 검색 |
| [세션 메모리 흐름](./docs/ko/session-memory-flow.md) | 세션 시작~종료 전체 데이터 흐름 |
