...
export default function BoardPanel() {
  ...
  if (!activeProject) {
    return (
      <div className="flex flex-col h-full items-center justify-center gap-2 bg-background rounded-lg border border-zinc-300 dark:border-zinc-600 text-center px-4">
  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col h-full overflow-hidden bg-background rounded-lg border border-border">
        ...
        {/* ── Toolbar ──────────────────────────────────────────── */}
        <div className="flex items-center gap-2 px-3 py-2.5 border-b border-border shrink-0 bg-white dark:bg-accent">
          <Users className="w-4 h-4 text-indigo-400 shrink-0" />
          <span className="text-lg font-medium text-foreground shrink-0">Team</span>
