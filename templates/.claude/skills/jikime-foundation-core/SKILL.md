...
Foundational principles and architectural patterns that power JikiME-ADK's AI-driven development workflow.
...
What is JikiME Foundation Core?
...
2. SPEC-First DDD - Specification-driven test-driven development workflow
...
Phase 3 Docs (/jikime:3-sync): API documentation, architecture diagrams, project reports.
...
Phase Separation: Execute /clear between phases, after /jikime:1-plan to save 45-50K, when context exceeds 150K, after 50+ messages.
