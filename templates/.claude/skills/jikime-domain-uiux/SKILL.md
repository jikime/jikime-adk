...
- frontend - Frontend component implementation
- architect - Design system architecture
- manager-quality - Accessibility and quality validation

Commands:

- /jikime:2-run - DDD implementation cycle
- /jikime:3-sync - Documentation generation
